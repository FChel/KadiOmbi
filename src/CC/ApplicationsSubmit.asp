		  ...
		  <div class="col-md-4 sidebar">
            ...
            <div class="panel panel-shadow panel-validation mb-3">
              <div class="panel-header">
                <h4><i class="fa fa-file"></i> Application Summary</h4>
            ...
            <div class="my-information">
              <ul class="nav nav-tabs" id="myFiTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" id="my-cards-tab" data-toggle="tab" href="#my-cards" role="tab" aria-controls="my-cards" aria-selected="true">Application Check Details</a> for <%=strApplicantUserName%>
                </li>
              </ul>
			  ...
			  <%
				...
				<div class="py-3"> 
					<div class="col-md-12 text-right my-auto">								
						<button type="button"  class="btn btn-primary btn-sm" onclick="self.location='Applications.asp'";> Close </button>
					</div>
				</div>
			</div>
        </div>
