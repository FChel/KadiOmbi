...
If Not IsEmpty(Request.QueryString("NAToDinersID")) Then
	strWhere = " WHERE NAToDinersID = " & Request.QueryString("NAToDinersID") & ""
Else
	'strWhere = " WHERE CardType = '" & strCardType & "' AND BatchNumber = 0"
End If
...
Dim strUpdateDate
	...
	objRS.Open "SELECT * FROM qryCAPSNAToDinersDetail WITH(NOLOCK) " & strWhere,objCon
		...
		If Not objRS.EOF Then
			...
			Response.Write "<tr><th>ID</th><th>Record Type</th><th>NA Detail</th><th>Status</th><th>Batch Number</th><th>Date Updated</th><th>Updated By</th><th>Employee ID</th></tr>"
			...
			Response.Write "<tr><td>" & objRS("NAToDinersID") & "</td><td>" & objRS("RecordType") & "</td><td>" & objRS("RecordText") & "</td><td>" & strStatusDisplay & "</td><td>" & objRS("FileSeqNum") & "</td>" & _
		...
		Else
			Response.write "NA File Details Not Found.  See System Admin."
	   End If
