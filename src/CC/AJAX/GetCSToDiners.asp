...
'		strCSToDinersID = " WHERE EID_No = '" & Request.QueryString("EmployeeID") & "' ORDER By Card_No,CSToDinersID DESC"
'		'strCSToDinersID = " WHERE EID_No = '" & Request.QueryString("EmployeeID") & "' ORDER By CSToDinersID DESC"
'	Else
'		strCSToDinersID = " WHERE EIDNo = '" & Request.QueryString("EmployeeID") & "' ORDER By CardNo,CSToDinersID DESC"
'	End If
	
'End If

If Not IsEmpty(Request.QueryString("CSToDinersID")) Then
	strCSToDinersID = strCSToDinersID & " WHERE CSToDinersID =" & Request.QueryString("CSToDinersID") & " ORDER By CSToDinersID DESC"
End If
...
End If
	...
	'objRS.Open "SELECT * FROM qryCAPSCSFromDinersAuditLog " & strCSToDinersID,objCon
	'If strType = "Archive" Then
	'	objRS.Open "SELECT * FROM tblCAPSCSToDiners WITH(NOLOCK) " & strCSToDinersID,objCon
		'response.write "SELECT * FROM tblCAPSCSToDiners_Archive2 WITH(NOLOCK) " & strCSToDinersID
	'Else
		objRS.Open "SELECT * FROM tblCAPSCSToDiners WITH(NOLOCK) " & strCSToDinersID,objCon
	'End If
		...
		If Not objRS.EOF Then
			...
			Response.Write "<table class=""table table-compact"">" & _
				"<tr><th style=""font-size:12px;"">CS ID</th><th  style=""font-size:12px;"">Status</th><th  style=""font-size:12px;"">File Seq Num</th><th  style=""font-size:12px;"">File Date Time</th><th  style=""font-size:12px;"">EID No</th><th  style=""font-size:12px;"">Name (T+FN+SN)</th><th  style=""font-size:12px;"">Card Number</th><th  style=""font-size:12px;"">Card Update Ind</th>" & _
		...
		Else
			Response.write "No CS TO Diners (" & strType & ") for " & Request.QueryString("EmployeeID") & " Card: " & strCSToDinersID'Request.QueryString("CardNo")'Request.QueryString("CSFromDinersID")
	   End If
		...
		Do Until objRS.EOF
			...
			Response.Write "<tr><td style=""font-size:12px;"">" & objRS("CSToDinersID") & "</td><td style=""font-size:12px;"">" & strStatus & "</td><td style=""font-size:12px;"">" & objRS("File_Seq_Num") & "</td><td style=""font-size:12px;"">" & objRS("File_Date_Time") & "</td><td style=""font-size:12px;"">" & objRS("EID_No") & "</td><td style=""font-size:12px;"">" & strName & "</td><td>" & MaskCard(objRS("Card_No")) & "</td>" & _
				"<td style=""font-size:12px;"">" & objRS("Card_Update_Ind") & "</td><td style=""font-size:12px;"">" & objRS("Card_Expiry_Date") & "</td><td style=""font-size:12px;"">" & Trim(objRS("Name_On_Card")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address_1")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address_2")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address_3")) & "</td>" & _
			...
			Else
				...
				"<td style=""font-size:12px;"">" & objRS("CardUpdateInd") & "</td><td style=""font-size:12px;"">" & objRS("CardExpiryDate") & "</td><td style=""font-size:12px;"">" & Trim(objRS("NameOnCard")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address1")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address2")) & "</td><td style=""font-size:12px;"">" & Trim(objRS("Address3")) & "</td>" & _
