...
If Not IsEmpty(Request.QueryString("ANZCardlistID")) Then
	strCSFromDinersID = " WHERE ANZCardlistID = " & Request.QueryString("ANZCardlistID") & ""
End If
...
Public Sub ShowDetails()
	...
	objRS.Open "SELECT * FROM qryCAPSCSFromDinersCard " & strCSFromDinersID,objCon
		...
		If Not objRS.EOF Then
			...
			Response.write "<div class=""row""><div class=""col-md-6""><div class=""row mb-3""><div class=""col-md-6""><h6 class=""mb-3"">ANZ Cardlist</h6></div>" & _
