...
strSQL = "SELECT COUNT([EmployeeID]) As Apps,ApplicationType,CAST(CAST(YEAR(DateSubmitted) as varchar(4)) As Varchar(8)) + '' + CAST(RIGHT('00'+CAST(Month(DateSubmitted) as varchar(2)),2) as varchar(2)) + '' + CAST(RIGHT('00'+CAST(Day(DateSubmitted) as varchar(2)),2) as varchar(2)) As YearMonthDay, " & _
		...
		"GROUP BY ApplicationType,CAST(CAST(YEAR(DateSubmitted) as varchar(4)) As Varchar(8)) + '' + CAST(RIGHT('00'+CAST(Month(DateSubmitted) as varchar(2)),2) as varchar(2)) + '' + CAST(RIGHT('00'+CAST(Day(DateSubmitted) as varchar(2)),2) as varchar(2)), " & _
...
<body>
  ...
  options: {
    title: {
      display: true,
      text: 'Card Application Types for <%=Session("ReportMonth") & "-" & Session("ReportYear")%>'
    }
  }
});
	</script>
