...
function DatePickChange() {
	self.location="ExportCS.asp?FileDate=" + document.getElementById("CSDate").value;
}
...
function loadCS() {
  ...
  xhttp.open("GET", "../../CC/AJAX/GetCSFile.asp?Deleted=N", true);
  xhttp.send();
...
<div class="modal fade" id="ModalApprove" tabindex="-1" role="dialog" aria-labelledby="ModalApprove" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-primary" onClick='window.location="../CSTransactionsTo.asp?Action=ExportCS"'><i class="fa fa-check"></i> Yes</button>
  ...
  <div class="col-3">
    <div class="card">
     <div class="card-header">
          <h4 class="card-title"><img src="../../CC/img/Diners2.png" height="40px" width="50px" title="Diners"> CS To Diners File Export</h4>
        </div>
...
<fieldset class="form-group">
	...
	<button type="button" class="btn btn-outline-secondary btn-sm" onClick="self.location='../CSTransactionsTo.asp'"><i class="fa fa-file"></i> View Details </button>
</fieldset>
<!--</div>-->
</p>
 <script>
...
If Not IsEmpty(Request.QueryString("BatchNo")) Then
	...
	Else
		strWhere = "WHERE Left(CardTypeSub,3) <> 'NAB' AND FileSeqNum = '" & Request.QueryString("BatchNo") & "'"
...
objRS.Open "SELECT TOP 100 * FROM qryCAPSCSToDiners "  & strWhere,objCon
	    ...
	    If objRS.eof Then
		    ...
		    Else
                ...
                "<tr><th colspan=""16"" style=""text-align:left"">Sample of Existing CS To Diners Data ready for export. Top " & intTopCount & " of <b>" & lngRecords & "</b> Total to be exported.</th></tr>" & _
		        "<tr><th Style=""width:20px;"">ID</th>" & _
				"<th style=""text-align:center; font-size:12px;"">Card Type</th><th style=""text-align:center; font-size:12px;"">Card Type Sub</th>" & _
				"<th style=""text-align:center; font-size:12px;"">EmployeeID</th>" & _
				"<th style=""text-align:center; font-size:12px;"">Card No</th><th style=""text-align:center; font-size:12px;"">Status</th>" & _	
		        "<th style=""text-align:center; font-size:12px;"">Title</th>" & _
	 	        "<th style=""text-align:center; font-size:12px;"">First Name</th>" & _	
	 	        "<th style=""text-align:center; font-size:12px;"">Surname</th>" & _
		        "<th style=""text-align:center; font-size:12px;"">Address 1</th><th style=""text-align:center; font-size:12px;"">Address 2</th>" & _
                "<th style=""text-align:center; font-size:12px;"">Address 3</th><th style=""text-align:center; font-size:12px;"">Suburb</th>" & _
                "<th style=""text-align:center; font-size:12px;"">State</th><th style=""text-align:center; font-size:12px;"">PostCode</th><th style=""text-align:center; font-size:12px;"">EmailAddress</th>" & _
                "<th style=""text-align:center; font-size:12px;"">Status</th><th style=""text-align:center; font-size:12px;"">File Seq No</th></tr>"
		        
		    End If
		    
		    Do until objRS.eof
		        'If objRS("GLCode") <> 0 Then
			    Response.Write "<TR class='clickable-row' data-href='../CSTransactionsTo.asp?BatchNo=" & objRS("FileSeqNum") & "&EIDNo=" & objRS("EIDNo") & "' style=""cursor: pointer; ; font-size:12px;""><TD>" & objRS("CSToDinersID") & "</TD>" & _
			                    ...
			                    "<TD style=""text-align:center; font-size:12px;"">" & objRS("EIDNo") & "</TD><TD style=""text-align:center; font-size:12px;"">" & objRS("CardNum") & "</TD><TD style=""text-align:center; font-size:12px;"">" & objRS("CardStatus") & "</TD>" & _
								...
								"<TD style=""text-align:center; font-size:12px;"">" & objRS("Email") & "</TD><TD style=""text-align:center; font-size:12px;"">" & objRS("Status") & "</TD><TD style=""text-align:center; font-size:12px;"">" & objRS("FileSeqNum") & "</TD>" & _
			                    "</TR>"
    			'End If
...
Dim strDateUpdatedTitle
	...
	dteBatchDateFormat = Year(dteBatchDate) & "-" & Right("0" & Month(dteBatchDate), 2) & "-" & Right("0" & Day(dteBatchDate), 2)
		...
		objRS.Open "SELECT TOP 10 * FROM tblCAPSFileLoad WITH(NOLOCK) WHERE Deleted = 'N' AND DateLoaded < '" & dteBatchDate & "' AND FileType = 'CSToDiners' ORDER BY FileSeqNum DESC",objCon
