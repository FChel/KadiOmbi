...
<table Class="CallCentre" WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	<tr>
		...
		<td Width="200px"><button type="button" tabindex="13" onclick="javascript:SaveData2();"><img src="../images/table_save.png" alt="" /> Apply Status to All</button></td>
		<TD Width="100px" style="BORDER-RIGHT:0px;vertical-align:middle;align-content:center">&nbsp;&nbsp;<%=strMessageIcon %></TD>
    <TD align="left" Width="800x" style="BORDER-RIGHT:0px"><INPUT style="Align:Left; font-weight:Bold; width:100%; text-align:left; color:<%=strMessageColour%>;" type="text" id="msgbox" name="msgbox" value="<%=strMessage%>"></TD>
	</tr>
</table>
<hr />
</form>
...
Sub SaveDetails()
      ...
      If Request.Form("StatusID") <> 0 or Request.Form("StatusID") <> 4 Then
		 ...
		 With objCmd
                ...
                .Parameters.Append objCmd.CreateParameter("Message", adVarChar, adParamOutput, 100)
			...
			'Return the result of the Save Function.
     		strMessage = objCmd.Parameters.Item("Message") 
            If strMessage = "RECORD SAVED" Then
...
Sub SaveAllRecord(StatusID)
    ...
    If StatusID <> 2 or StatusID <> 4 Then
        ...
        strMessageIcon = "&nbsp;&nbsp;<img src=""../images/check-icon.png"" />"
        strMessage = "All VOTES HAVE BEEN UPDATED."
    Else
       strMessageIcon = "<img src=""../images/warning.gif"" />"
       strMessage = "APPLY ALL FUNCTION CANNOT BE USED FOR STATUS 'COMPLETED' or 'APPROVED'.  THESE MUST BE SET INDIVIDUALLY."
