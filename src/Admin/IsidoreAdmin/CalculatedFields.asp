...
<tr><th style="text-align:left; height:20px">&nbsp;Calculated Field</th>				
		<td align="left" >&nbsp;<input style="text-align:left; height:20px" type="text"  name="lngCalculatedField" value="<%=lngCalculatedField%>" readonly="x"  /></td>
		</tr>
	...
	<th style="text-align:left; height:20px; width:40%;">&nbsp;Calculated Field Type</th>
		<td style="text-align:left; height:20px; width:60%;">
	        ...
	        <%		
		    objRS.Open "SELECT DISTINCT(CalculatedFieldType) FROM tblCalculatedFields WHERE BudgetID = " & Session("BudgetID") & " AND Active = 'Y'",objCon
