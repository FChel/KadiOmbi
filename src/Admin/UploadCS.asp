...
<TABLE Width="800px" BORDER="0" CELLSPACING="0" CELLPADDING="0">
<TR>
    <td Width="200px"><button type="button" onclick="window.open('CSFromDinersTemplateExcel.asp')"><img src="../images/page_excel.png" alt="Click here to get an Excel Template for loading the CS FRom Diners file" /> CS From Diners Template Excel </button></td>
</TR>
</TABLE>
</div>
...
<% 
        ...
        objRS.Open "SELECT TOP 50 * FROM qryCSFromDiners ",objCon
